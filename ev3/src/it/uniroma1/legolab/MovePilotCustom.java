 ...
 * 
 **/
public class MovePilotCustom implements ArcRotateMoveController {
   ...
   */
  @Deprecated
  public MovePilotCustom(final double wheelDiameter, final double trackWidth, final RegulatedMotor leftMotor,
   ...
   */
  @Deprecated 
  public MovePilotCustom(final double leftWheelDiameter, final double rightWheelDiameter, final double trackWidth,
   ...
   */
  public MovePilotCustom(Chassis chassis) {
